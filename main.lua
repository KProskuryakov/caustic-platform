function love.load ()
  ...
  player = {x = 0, y = 0, velX = 0, velY = 0, w = 40, h = 40, imagew = 40, imageh = 40, image = love.graphics.newImage('player.png')}
  level1 = {
    walls = {
...
function love.update (dt)
  ...
  player.velY = math.min(player.velY + gravity * dt, terminalVelocity*dt)
